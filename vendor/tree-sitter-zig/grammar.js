...
module.exports = grammar({
  ...
  conflicts: $ => [
    [$.identifier, $.using_namespace_declaration],
    [$.identifier, $.async_expression],
  ...
  rules: {
    ...
    container_field: $ => prec.right(prec.dynamic(1, seq(
      ...
      choice(
        seq(
          ...
          ':',
          field('type', choice($.primary_type_expression, $.error_set_declaration, $.if_type_expression, $.comptime_type_expression)),
        ),
    ...
    // Removed keywords remain accepted in legacy syntax, but are ordinary
    // identifiers in Zig 0.16. Do not reserve them in identifier positions.
    identifier: $ => choice($._identifier, seq('@', $.string),
      'usingnamespace', 'async', 'await'),
